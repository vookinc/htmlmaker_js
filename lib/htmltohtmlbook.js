...
extractparas.forEach(function ( val ) {
 ...
 // remove leading and trailing versatile paras from extract blocks
 versatileblockparas.forEach( function( versatilepara ) {
   // select versatile paras without extract p's as prior siblings, move them before parent
   var leadingversatileparas = $("blockquote.tempextractclass "+versatilepara+":not("+extractparas+" ~ "+versatilepara+")");
      leadingversatileparas.each(function() {
      var myParent = $(this).parent();
      $(this).insertBefore(myParent);
    });
   // loop through last-children versatile paras and move them after the parent
   while ($("blockquote.tempextractclass "+versatilepara+":last-child").length > 0) {
     $("blockquote.tempextractclass "+versatilepara+":last-child").each( function() {
       var myParent = $(this).parent();
...
// remove leading and trailing versatile paras from epigraph blocks
versatileblockparas.forEach( function( versatilepara ) {
  // select versatile paras without epigraph p's as prior siblings, move them before parent
  var leadingversatileparas = $("blockquote[data-type=epigraph] "+versatilepara+":not("+epigraphparas+" ~ "+versatilepara+")");
     leadingversatileparas.each(function() {
     var myParent = $(this).parent();
     $(this).insertBefore(myParent);
   });
  // loop through last-children versatile paras and move them after the parent
  while ($("blockquote[data-type=epigraph] "+versatilepara+":last-child").length > 0) {
    $("blockquote[data-type=epigraph] "+versatilepara+":last-child").each( function() {
      var myParent = $(this).parent();
       $(this).insertAfter(myParent);
    });
  };
...
poetryparas.forEach(function ( val ) {
 ...
 // remove leading and trailing versatile paras from poetry pre blocks
 versatileblockparas.forEach( function( versatilepara ) {
   // select versatile paras without poetry p's as prior siblings, move them before parent
   var leadingversatileparas = $("pre.poetry "+versatilepara+":not("+poetryparas+" ~ "+versatilepara+")");
      leadingversatileparas.each(function() {
      var myParent = $(this).parent();
      $(this).insertBefore(myParent);
    });
   // loop through last-children versatile paras and move them after the parent
   while ($("pre.poetry "+versatilepara+":last-child").length > 0) {
     $("pre.poetry "+versatilepara+":last-child").each( function() {
       var myParent = $(this).parent();
        $(this).insertAfter(myParent);
     });
   };
...
boxparas.forEach(function ( val ) {
 ...
 // remove leading and trailing versatile paras from box <aside> blocks
 versatileblockparas.forEach( function( versatilepara ) {
   // select versatile paras without box p's as prior siblings, move them before parent
   var leadingversatileparas = $("aside.box "+versatilepara+":not("+boxparas+" ~ "+versatilepara+")");
      leadingversatileparas.each(function() {
      var myParent = $(this).parent();
      $(this).insertBefore(myParent);
    });
   // loop through last-children versatile paras and move them after the parent
   while ($("aside.box "+versatilepara+":last-child").length > 0) {
     $("aside.box "+versatilepara+":last-child").each( function() {
       var myParent = $(this).parent();
        $(this).insertAfter(myParent);
     });
   };
...
sidebarparas.forEach(function ( val ) {
 ...
 // remove leading and trailing versatile paras from sidebar <aside> blocks
 versatileblockparas.forEach( function( versatilepara ) {
   // select versatile paras without sidebar p's as prior siblings, move them before parent
   var leadingversatileparas = $("aside[data-type=sidebar] "+versatilepara+":not("+sidebarparas+" ~ "+versatilepara+")");
      leadingversatileparas.each(function() {
      var myParent = $(this).parent();
      $(this).insertBefore(myParent);
    });
   // loop through last-children versatile paras and move them after the parent
   while ($("aside[data-type=sidebar] "+versatilepara+":last-child").length > 0) {
     $("aside[data-type=sidebar] "+versatilepara+":last-child").each( function() {
       var myParent = $(this).parent();
        $(this).insertAfter(myParent);
     });
   };
